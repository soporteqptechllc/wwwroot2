...
#from components.views import file_upload_view, file_upload_inventario
...
urlpatterns = [
    ...
    path('formfileupload1',views.FormFileuploadView1.as_view(),name='forms-formfileupload1'),
    path('formfileupload2',views.FormFileuploadView2.as_view(),name='forms-formfileupload2'),
    path('formfileupload3',views.FormFileuploadView3.as_view(),name='forms-formfileupload3'),
    path('formtanks1', views.FormTanksView1.as_view(),name='forms-formtanks1'),
    path('mezclaslistas', views.TanksViewMezclasListas.as_view(),name='Mezclas-Listas'),
    path('mezclaslistas2', views.TanksViewMezclasListas2.as_view(),name='Mezclas-Listas2'),
    path('Tocumen212', views.TanksViewMezclasListas211.as_view(),name='Tocumen-21-2'),
    path('Tocumen213', views.TanksViewMezclasListas212.as_view(),name='Tocumen-21-3'),
    path('Tocumen253', views.TanksViewMezclasListas213.as_view(),name='Tocumen-25-3'),
    path('silo/<int:silo>/<int:dia>/<fecha>/', views.TanksViewSilosListas.as_view(),name='SiloJG'),

    path('upload/', views.file_upload_view, name= 'upload_view'),
    path('upload1/', views.file_upload_view1, name='upload_view1'),
    path('upload2/', views.file_upload_view2, name='upload_view2'),
    path('uploadtxt/', views.file_upload_inventario, name='uploadtxt'),
    path('uploadxlsx/', views.file_upload_repuestos1, name='uploadxlsx'),
