...
#                     No_encontrado=0
#                 else:
#                     suma=float(df['       Stock total'][Destino])+float(df['       Stock total'][j])
#                     df['       Stock total'][Destino]=suma
                    
#                 df_equipos.Material[m_id] = int(df_inventario.id[j])
                
#                 print(j,df_equipos.Material[m_id])
#             j +=1
#         if No_encontrado:
#             df_equipos.Material[m_id] = 0        
#     m_id +=1