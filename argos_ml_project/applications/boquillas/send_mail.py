...
def mail(to, subject, filename, file_path):
    ...
    # create server (Cambios JG)
    #server = smtplib.SMTP('smtp.mail.me.com: 587')
    #server = smtplib.SMTP('smtp.mail.me.com: 587', timeout=120)
    server = smtplib.SMTP('smtp.mail.me.com: 465', timeout=120)
    #server = smtplib.SMTP_SSL('smtp.mail.me.com: 587', timeout=120)
